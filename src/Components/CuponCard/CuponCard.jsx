    ...
    <div>
      <div className=" flex ">
        <div className="flex gap-2  shadow-sm shadow-gray-300 rounded-md  rounded-r-xl">
          <img className="w-28 h-28" src={image} alt="Discount" />
          <div className=" px-3">
            ...
            <h1 className="text-lg text-red-500 font-bold">{title}</h1>
        ...
        <div className=" p-2 px-4 w-44 shadow-sm shadow-gray-300 rounded-md border-l-2 border-dashed rounded-l-xl">
          <div
            ...
            className=" bg-primary-color cursor-pointer  bg-opacity-10 text-lg mx-auto text-primary-color px-2 rounded-sm border-2 border-primary-color border-dashed w-fit flex flex-col items-center"
          >
